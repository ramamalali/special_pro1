    ...
    <>
      <div className="footer">
        <div className="flex justify-between items-start pb-10">
          ...
          <div>
            <p className="font-semibold text-base mt-2">Links</p>
            <ul>
              <Link to="">
              ...
              <Link to="">
                <li className="mt-2 text-sm">Our Service</li>
              </Link>
            </ul>
          </div>
          <div>
            <p className="font-semibold mt-2 mb-4">Contact Us</p>
            <span className="text-sm rounded-2xl py-1.5 px-2.5 email-background">
              user@gmail.com
            </span>
          </div>
        </div>
        <div className="flex justify-center items-center flex-col">
          <p className="font-semibold mb-4">Join Our Community</p>
          <div className="flex justify-between items-center gap-8 mb-11 social">
